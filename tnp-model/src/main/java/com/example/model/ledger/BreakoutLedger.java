...
public class BreakoutLedger implements Serializable{
	 ...
	 * - RULE 2 is true
	 */
	public enum BreakoutCategory { ALL_EMA_TREND_UP, CROSS20, CROSS50, CROSS200, LOW_ABOVE_EMA20, DEATHCROSS50, DEATHCROSS200, SILVER_CROSS, GOLDEN_CROSS, DAY_OPEN_LOWEST, DAY_OPEN_HIGHEST, GAP_UP, GAP_DOWN, BREAK50EMA, BREAKDOWN_PENDING_CONFIRMATION, BREAKDOWN_CONFIRMED,BREAKDOWN_CONFIRMED_S1_BREAKDOWN, BREAKDOWN_NOT_CONFIRMED, EMA20BELOW50, MACD_CROSSED_SIGNAL, SIGNAL_CROSSED_MACD, SIGNAL_NEAR_HISTOGRAM, VOLUME_HIGH, RSI_CONTINUED_BULLISH, RSI_ENTERED_BULLISH,RSI_ENTERED_BEARISH, ADX_TREND_UP,CLOSE_BELOW_20, CLOSE_BELOW_50, BREAK_EMA50_SUPPORT, BULLISH_ENGULFING, BEARISH_ENGULFING, DOJI, BEARISH_MURUBOZU, BULLISH_MURUBOZU, OPEN_EQUAL_PREV_CLOSE_GREEN, YEAR_HIGH, BREAKOUT_PAST_RESISTANCE, BREAKDOWN_PAST_SUPPORT}
