...
public class TradingHolidayAdminController {
    ...
    public ResponseEntity<Map<String, Object>> getAllHolidays(
        ...
        return JsonApiSuccessUtil.ok("Trading holidays retrieved successfully", Map.of(
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> createHoliday(@RequestBody @Valid TradingHoliday holiday) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> updateHoliday(@PathVariable Long id, @RequestBody @Valid TradingHoliday holiday) {
        return tradingHolidayService.updateHoliday(id, holiday)
                .map(updated -> JsonApiSuccessUtil.updated("Holiday updated successfully", updated))
                .orElse(JsonApiErrorUtil.createErrorResponse(HttpStatus.NOT_FOUND, "Holiday Not Found", "No holiday found with the given ID."));
    }
    ...
    public ResponseEntity<Map<String, Object>> deleteHoliday(@PathVariable Long id) {
        ...
        if (deleted) {
            ...
            return JsonApiErrorUtil.createErrorResponse(HttpStatus.NOT_FOUND, "Holiday Not Found", "No holiday found with the given ID.");
        }
    }
}
