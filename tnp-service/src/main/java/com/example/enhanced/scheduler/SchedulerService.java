package com.example.enhanced.scheduler;

import com.example.enhanced.model.StockPriceIN;
import com.example.enhanced.processor.BhavProcessor;
...
public class SchedulerService {
    ...
    public void scheduleBhavcopyDownload() {
        ...
        try {
            log.info("Starting scheduled Bhavcopy download for session date: {}", sessionDate);
            ...
            log.error("Bhavcopy download failed for {}: {}", sessionDate, e.getMessage());
        }
    }
}
