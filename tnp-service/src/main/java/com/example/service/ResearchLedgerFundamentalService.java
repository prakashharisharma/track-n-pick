...
public class ResearchLedgerFundamentalService {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ResearchLedgerFundamentalService.class);

    @Autowired private ResearchLedgerFundamentalRepository researchLedgerRepository;

    public void addResearch(Stock stock, ValuationLedger entryValuation) {

        ResearchLedgerFundamental researchLedger =
                researchLedgerRepository.findByStockAndResearchStatus(stock, Trade.Type.BUY);
        ...
        if (researchLedger == null) {
            ...
            LOGGER.debug(
                    stock.getNseSymbol() + " is already in Ledger for " + stock.getNseSymbol());
        }
    }
    ...
    public void updateResearchNotified(ResearchLedgerFundamental researchLedger) {
        ...
        ResearchLedgerFundamental researchLedger1 =
                researchLedgerRepository.findBySrlId(researchLedger.getSrlId());
    ...
    public boolean isResearchActive(Stock stock) {
        ...
        ResearchLedgerFundamental researchLedgerFundamental =
                researchLedgerRepository.findByStockAndResearchStatus(stock, Trade.Type.BUY);
