...
public class CrossOverUtil {
    ...
    /**
     * A bullish crossover occurs when the shorter / fast moving average crosses above the
     * longer / slow moving average.
     * @param prevFastAvg
     * @param prevSlowAvg
     * @param fastAvg
     * @param slowAvg
     * @return
     */
    public static boolean isFastCrossesAboveSlow(double prevFastAvg, double prevSlowAvg,
