...
/**
 * Service interface for RSI (Relative Strength Index) analysis. Provides methods to determine
 * bullish/bearish conditions, overbought/oversold zones, and RSI trend movements.
 */
public interface RsiIndicatorService {

    /**
     * Determines if the stock is in a bullish RSI condition. A stock is considered bullish if the
     * RSI is increasing and crosses above the oversold threshold.
     *
    ...
    /**
     * Checks if the stock is in an oversold condition. An oversold condition occurs when RSI is
     * below or equal to the oversold threshold.
     *
     * @param stockTechnicals The stock's technical data.
    ...
    /**
     * Determines if the stock is in a bearish RSI condition. A stock is considered bearish if the
     * RSI is decreasing and crosses below the overbought threshold.
     *
     * @param stockTechnicals The stock's technical data.
    ...
    /**
     * Checks if the stock is in an overbought condition. An overbought condition occurs when RSI is
     * above or equal to the overbought threshold.
     *
     * @param stockTechnicals The stock's technical data.
