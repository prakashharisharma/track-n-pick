...
/**
 * Service interface for multi-indicator analysis. Provides methods to determine whether a stock is
 * in a bullish or bearish trend based on various technical indicators.
 *
 * @author phs
 */
public interface MultiIndicatorService {
     ...
     * Typically considers factors like: - RSI increasing (indicating growing strength) - MACD
     * histogram increasing (showing bullish momentum) - ADX confirming a strong trend
     *
     ...
     * Typically considers factors like: - RSI decreasing (indicating weakening strength) - MACD
     * histogram decreasing (showing bearish momentum) - ADX confirming a strong downward trend
     *
     * @param stockTechnicals The technical data of the stock.
