...
public class RedisConfig {
    ...
    @Autowired private RedisConfigurationProperties redisProperties;
    ...
    /** Creates connection factory for standalone Redis. Useful for local or test environment. */
    @Bean
    ...
    /** Creates connection factory for Redis Cluster. Used in AWS or production environments. */
    @Bean
    @ConditionalOnProperty(
            prefix = "spring.redis.cluster",
            name = "enabled",
