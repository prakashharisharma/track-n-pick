...
@Service
public class UpdateResearchProcessor implements Processor{

	private static final Logger LOGGER = LoggerFactory.getLogger(UpdateResearchProcessor.class);
