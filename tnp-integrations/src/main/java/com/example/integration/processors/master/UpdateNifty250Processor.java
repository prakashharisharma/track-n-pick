...
@Service
public class UpdateNifty250Processor implements Processor {

	private static final Logger LOGGER = LoggerFactory.getLogger(UpdateNifty250Processor.class);
	...
	public void process(Exchange exchange) throws Exception {
		...
		nseNifty200List.forEach(stockIn -> {
			StockIO stockIO = new StockIO(stockIn.getCompanyName(), stockIn.getSector(), stockIn.getNseSymbol(),
					stockIn.getSeries(), stockIn.getIsin(), IndiceType.NIFTY250);
