...
public class QuartzRouteDaily extends RouteBuilder{
	...
	public void configure() throws Exception {
		...
		from("quartz2://everyDayAt_9_30?cron=0+01+10+?+*+MON,TUE,WED,THU,FRI+*").process(downloadNSEBhavProcessor)
		...
		from("quartz2://everyDayAt_9_45?cron=0+35+10+?+*+MON,TUE,WED,THU,FRI+*").process(emailPortfolioProcessor)
		.to("log:everyDayAt_10_45");
		
		from("quartz2://everyDayAt_16_00?cron=0+40+10+?+*+MON,TUE,WED,THU,FRI+*").process(emailResearchProcessor)
