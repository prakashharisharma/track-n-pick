...
public class QuartzRouteYearly extends RouteBuilder {
	...
	public void configure() throws Exception {
		// 0 45 10 1 JAN ? *
		from("quartz2://every_01_Jan_At_10_45?cron=0+15+09+1+JAN+?+*").process(updateCYROProcessor)
				.to("log:every_01_Jan_At_10_45");

		// 0 45 10 1 APR ? *
		from("quartz2://every_01_APR_At_10_45?cron=0+15+09+1+APR+?+*").process(updateFYROProcessor)
